...
function uidExists($conn, $username, $email)
{
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ../../sites/zarejestruj.php?error=stmtfailed");
        exit();
    }
...
function createUser($conn, $fname, $lname, $email, $username, $pwd, $role)
{
    ...
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
    header("location: ../../sites/zarejestruj.php?error=none");
    return true;
}
...
function loginUser($conn, $username, $pwd)
{
    ...
    if ($uidExists === false) {
        header("location: ../../sites/zaloguj.php?error=wronglogin");
        exit();
    }
